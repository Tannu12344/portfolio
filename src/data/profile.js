/**
 * Core identity content. Edit this file to update who "you" are across
 * the entire site — components should never hardcode this content.
 */

export const profile = {
  name: 'Tannu Singh',
  role: 'Frontend Engineer',
  stack: ['React', 'JavaScript', 'Frontend Architecture', 'AI'],
  tagline: 'I build interfaces that feel as good as they work.',
  status: 'Available for work',
  location: 'Bengaluru, India',
  bio:
    "I'm a frontend engineer who treats interfaces like systems — " +
